...
<body>
    ...
    <section class="flex justify-center items-center text-lg py-2">
        <form action="./formhelp/reghelp.php" class="flex justify-center md:w-[500px]" method="post">
            <div class="w-full my-6">
                ...
                <input class="block my-2 px-4 py-1 w-full rounded-md border border-gray-500 text-black font-normal focus:outline-none" type="email" name="email" placeholder="Email...">
                <label class="block my-2" for="phone">Enter Phone Number</label>
                <input class="block my-2 px-4 py-1 w-full rounded-md border border-gray-500 text-black font-normal focus:outline-none" type="text" name="phone" placeholder="Phone Number...">

                <label class="block my-2" for="password">Enter Password</label>
                <input class="block my-2 px-4 py-1 w-full rounded-md border border-gray-500 text-black font-normal focus:outline-none" type="password" name="password" placeholder="Password...">
                <label class="block my-2" for="cpassword">Enter Password Again</label>
                <input class="block my-2 px-4 py-1 w-full rounded-md border border-gray-500 text-black font-normal focus:outline-none" type="password" name="cpassword" placeholder="Confirm Password...">
