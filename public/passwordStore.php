            ...
            <div class="">
                ...
                <ul class="mr-10 hidden sm:flex" id="navmenu">
                    <li class="px-4 font-nunito hover:text-white">
                        <a href="personnal.php?email=<?php echo $email; ?>">Personal Info</a>
                    </li>
                    <li class="px-4 font-nunito hover:text-white">
                        <a href="./idCards.php?email=<?php echo $email; ?>">ID cards</a>
                    </li>
                    <li class="px-4 font-nunito hover:text-white">
                        <a href="./passwordStore.php?email=<?php echo $email; ?>">Email Store</a>
                    </li>
                    <li class="px-4 font-nunito hover:text-white">
